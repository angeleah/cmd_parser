...
(describe "decoding structured message"
	...
	(it "should return a list with an id and a message when it receives a string"
		(should= "hello" (decode-structured-message "5, cool;")))
...
;		(should= (5 "cool") (decode-structured-messages "5, cool; 7, sweet; 12, what; 14, OMG;")))
...
(describe "creating multiple structured messages at once"
	...
	(it "should throw an exception when passed a number out of the range of 0 - 255."
		(should-throw Exception "The number needs to be within range of 0 - 255." (create-structured-messages '((387, "cool")))))

	(it "should throw an exception when passed something that is NAN as the command id."
		(should-throw Exception "The command id needs to be a number." (create-structured-messages '(("a", "cool")))))
		
	(it "should throw an exception if the message is not a string."
		(should-throw Exception "The message needs to be a string." (create-structured-messages '((12, 16)))))
